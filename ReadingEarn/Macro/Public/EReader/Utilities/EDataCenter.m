...
//        if ([EDataSourceManager shareInstance].chapterInfoArray.count >0) {
//            EEveryChapter *chapter = [EDataSourceManager shareInstance].chapterInfoArray[0];
...
+ (NSInteger)e_getChapterBefore:(NSString *)chapter_number {

    if (![chapter_number isEqualToString:@""]) {
        return [chapter_number integerValue];
    } else {
