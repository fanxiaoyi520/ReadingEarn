...
- (void)leftListView:(ELeftListView *)leftListView footerWithRefreshing:(NSString *)str {
    if (self.delegate && [self.delegate respondsToSelector:@selector(leftDrawerView:turnfooterWithRefreshing:)]) {
        [self.delegate leftDrawerView:self turnfooterWithRefreshing:str];
    }
}
