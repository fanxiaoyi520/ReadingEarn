...
@interface REEndBookTypeTableViewCell()
...
@end
@implementation REEndBookTypeTableViewCell
...
- (void)showDataWithModel:(REEndBookTypeModel *)model {
    ...
    //5.
    CGSize statusLabelSize = [self sizeWithText:model.labels withFont:REFont(12)];
    
    NSMutableAttributedString *statusLabelstring = [[NSMutableAttributedString alloc] initWithString:model.labels attributes:@{NSFontAttributeName: REFont(12), NSForegroundColorAttributeName: [UIColor colorWithRed:247/255.0 green:100/255.0 blue:66/255.0 alpha:1.0]}];
